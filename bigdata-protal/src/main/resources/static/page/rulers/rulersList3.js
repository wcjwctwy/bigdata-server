layui.config({
	...
	var form = layui.form(),
		...
		$ = layui.jquery;
    var manageUrl = "http://bigdata.lsmsp.cn:8088";
//     $.get(manageUrl+"/ruler/list?page=" + 1, function(data){
//         var datastr = renderDate(data.data);
//         $(".news_content").html(datastr);
//     });
// //加载数据
...
//                     + '<td align="left">' + data[i].groupName + '</td>'
//                     + '<td align="left">' + data[i].rulerName + '</td>'
//                     + '<td align="left">' + data[i].regex + '</td>'
//                     + '<td align="left">' + data[i].rulerContent + '</td>';
//                 if (data[i].status == 2) {
//                     dataHtml += '<td> <input type="checkbox" name="show" lay-skin="switch" lay-text="是|否" lay-filter="isShow" checked=""/></td>';
//                 } else {
//                     dataHtml += '<td><input type="checkbox" name="show" lay-skin="switch" lay-text="是|否" '  + '></td>';
//                 }
//
//                 dataHtml += '<td>' + data[i].createdTime + '</td>'
...
//         , jump: function (obj) {
//             $.ajax({
//                 url: manageUrl + "/ruler/list?page=" + obj.curr,
//                 type: "get",
//                 success: function (data) {
